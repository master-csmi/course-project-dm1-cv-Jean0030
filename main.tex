...
\begin{tabular}{r| p{0.5\textwidth} c}
    ...
    {Student exchange}
    {Montreal - Canada\color{cvred}}{This year completed the third year of my bachelor's in Applied Mathematics with a student exchange program. I studied with ODE, PDE, differential forms and Object-Oriented Programming in depth. }{Empty.png}\\
    \cvevent{2022--2025}{Bachelor's in Applied Mathematics}{University of Strasbourg}
    {Strabourg -France\color{cvred}}
    {This degree gave me fundamental knowledge in computer science and mathematics such as numerical analysis, differential calculus or statistics. }{Empty.png}\\
